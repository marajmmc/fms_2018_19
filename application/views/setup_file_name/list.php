        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                [
                    ...
                    { text: '<?php echo $CI->lang->line('LABEL_HC_LOCATION'); ?>', dataField: 'hc_location',filtertype:'list',width:'200', hidden: <?php echo $system_preference_items['hc_location']?0:1;?>},
                    { text: '<?php echo $CI->lang->line('LABEL_CATEGORY_NAME'); ?>', dataField: 'category_name', filtertype:'list', width:'180', hidden: <?php echo $system_preference_items['category_name']?0:1;?>},
