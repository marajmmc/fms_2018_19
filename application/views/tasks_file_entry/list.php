        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                columns:[
                    ...
                    { text: '<?php echo $CI->lang->line('LABEL_SUB_CATEGORY_NAME'); ?>',dataField: 'sub_category_name',width:130,rendered: tooltiprenderer,hidden: <?php echo $system_preference_items['sub_category_name']?0:1;?>},
                    { text: '<?php echo $CI->lang->line('LABEL_CLASS_NAME'); ?>',dataField: 'class_name',width:150,rendered: tooltiprenderer,hidden: <?php echo $system_preference_items['class_name']?0:1;?>},
                    { text: '<?php echo $CI->lang->line('LABEL_TYPE_NAME'); ?>',dataField: 'type_name',width:130,rendered: tooltiprenderer,hidden: <?php echo $system_preference_items['type_name']?0:1;?>},
