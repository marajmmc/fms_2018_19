...
<form id="save_form" action="<?php echo site_url($CI->controller_url.'/index/save_new_file');?>" method="post">
    ...
    <div class="row widget">
        ...
        <div class="row show-grid" id="sub_category_container" style="<?php if($category_counter>1){echo 'display:none';} ?>">
            <div class="col-xs-4">
        ...
        <div class="row show-grid" id="class_container" style="<?php if($sub_category_counter>1){echo 'display:none';} ?>">
            <div class="col-xs-4">
        ...
        <div class="row show-grid" id="type_container" style="<?php if($class_counter>1){echo 'display:none';} ?>">
            <div class="col-xs-4">
        ...
        <div class="row show-grid">
            <div class="col-xs-4">
                <label class="control-label pull-right"><?php echo $this->lang->line('LABEL_HC_LOCATION'); ?> <span style="color:#FF0000">*</span></label>
            </div>
            <div class="col-sm-4 col-xs-8">
        ...
        <div class="row show-grid">
            <div class="col-xs-4">
                <label class="control-label pull-right"><?php echo $this->lang->line('LABEL_FILE_STATUS'); ?> <span style="color:#FF0000">*</span></label>
            </div>
            <div class="col-sm-4 col-xs-8">
