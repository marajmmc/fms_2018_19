...
<form id="save_form" action="<?php echo site_url($CI->controller_url . '/index/save'); ?>" method="post">
    ...
    <div class="row widget">
        ...
        <div class="row show-grid" id="class_container" style="<?php echo (!($item['id_class']>0))? 'display:none':''; ?>">
            <div class="col-xs-4">
            ...
            <div class="col-sm-4 col-xs-8">
                <select id="id_class" name="item[id_class]" class="form-control">
                    ...
                    foreach($classes as $class){ ?>
                        <option value="<?php echo $class['id']?>" <?php if($class['id']==$item['id_class']){echo "selected";}?>><?php echo $class['name'];?></option>
                    <?php } ?>
                </select>
            </div>
        </div>
